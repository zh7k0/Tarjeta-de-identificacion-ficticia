<div class="table">
        ...
        <div class="table__row">
            ...
            <div class="table__cell">${{ number_format($servicio->tarifa, 0, ',', '.') }}</div>
            ...
            <div class="table__cell"><a class="facturar" href="{!! action('FacturaController@store', ['contribuyente' => $rutContribuyente, 'servicio' => $servicio->servicios__tipo_servicio]) !!}">Facturar</a></div>
        </div>
        @empty
        <div class="table__row">
